...
export default function Page() {
  return (
    <div className="bg-zinc-50 dark:bg-zinc-950 font-light antialiased transition-colors duration-300">
      ...
      <nav className="fixed top-0 w-full bg-zinc-50/70 dark:bg-zinc-950/70 backdrop-blur-xl z-50 border-b border-zinc-200 dark:border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="font-medium text-lg tracking-tighter text-zinc-900 dark:text-zinc-50 flex items-center gap-3">
            <Logo size={28} />
            iMemo
          </div>
          <div className="flex items-center gap-4">
            ...
            <Link 
              href="/download" 
              className="text-xs font-medium text-zinc-50 dark:text-zinc-950 bg-zinc-900 dark:bg-zinc-50 hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors px-4 py-1.5 rounded-full flex items-center gap-2"
            >
              <Download size={12} />
              Download
            </Link>
      ...
      >
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-sky-200 dark:border-sky-900/30 bg-sky-50 dark:bg-sky-900/10 text-xs text-sky-600 dark:text-sky-300 mb-8">
            <Icon icon="solar:star-fall-minimalistic-linear" className="text-sky-500 dark:text-sky-400 text-sm" />
            The Ultimate Clipboard Companion
          </div>
          <h1 className="md:text-6xl lg:text-7xl leading-tight text-4xl font-medium text-zinc-900 dark:text-zinc-50 tracking-tighter max-w-4xl mx-auto mb-8">
            Your Clipboard, <span className="text-zinc-400 dark:text-zinc-600">Reimagined for Productivity.</span>
          </h1>
          <p className="text-base md:text-lg text-zinc-600 dark:text-zinc-400 mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              href="/download" 
              className="w-full sm:w-auto text-sm font-medium text-zinc-50 dark:text-zinc-950 bg-zinc-900 dark:bg-zinc-50 hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-all px-8 py-3 rounded-full text-center flex items-center justify-center gap-2"
            >
              <Download size={16} />
              Download Now
            </Link>
            <Link 
              href="#features" 
              className="w-full sm:w-auto text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors px-8 py-3 rounded-full text-center flex items-center justify-center gap-2"
            >
      ...
      <section id="features" className="border-white/5 border-t pt-24 px-6 pb-24">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16 md:mb-24">
            <h2 className="text-2xl md:text-4xl font-medium tracking-tight text-zinc-900 dark:text-zinc-50 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-fr">
            {/* Bento Item 1 (Wide) */}
            <div className="col-span-1 md:col-span-2 p-8 rounded-3xl border border-zinc-200 dark:border-white/5 bg-zinc-100/50 dark:bg-zinc-900/20 relative overflow-hidden group hover:bg-zinc-200/50 dark:hover:bg-zinc-900/40 transition-colors">
              ...
              <div className="relative z-10 h-full flex flex-col justify-end pt-12">
                <h3 className="text-xl font-medium tracking-tight text-zinc-900 dark:text-zinc-50 mb-3">Persistent History</h3>
            ...
            {/* Bento Item 2 */}
            <div className="col-span-1 p-8 rounded-3xl border border-zinc-200 dark:border-white/5 bg-zinc-100/50 dark:bg-zinc-900/20 group hover:bg-zinc-200/50 dark:hover:bg-zinc-900/40 transition-colors">
              <Zap className="text-2xl text-zinc-500 mb-6" />
              <h3 className="text-lg font-medium tracking-tight text-zinc-900 dark:text-zinc-50 mb-2">Instant Paste</h3>
            ...
            <div className="col-span-1 p-8 rounded-3xl border border-zinc-200 dark:border-white/5 bg-zinc-100/50 dark:bg-zinc-900/20 group hover:bg-zinc-200/50 dark:hover:bg-zinc-900/40 transition-colors">
              ...
              <h3 className="text-lg font-medium tracking-tight text-zinc-900 dark:text-zinc-50 mb-2">Global Hotkeys</h3>
              <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
            ...
            <div className="col-span-1 md:col-span-2 p-8 rounded-3xl border border-zinc-200 dark:border-white/5 bg-zinc-100/50 dark:bg-zinc-900/20 relative overflow-hidden group hover:bg-zinc-200/50 dark:hover:bg-zinc-900/40 transition-colors">
              ...
              <div className="relative z-10 h-full flex flex-col justify-end pt-12">
                <h3 className="text-xl font-medium tracking-tight text-zinc-900 dark:text-zinc-50 mb-3">Lightning Fast Search</h3>
                <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed max-w-md">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-32">
              <h2 className="text-2xl md:text-4xl font-medium tracking-tight text-zinc-900 dark:text-zinc-50 mb-6">
                Designed for Focus.
              </h2>
          ...
          <div className="lg:w-2/3 space-y-8">
            <div className="p-8 md:p-10 rounded-3xl border border-zinc-200 dark:border-white/5 bg-zinc-100/50 dark:bg-zinc-900/10 flex flex-col md:flex-row gap-8 items-start">
              <div className="w-12 h-12 rounded-full bg-zinc-200 dark:bg-zinc-900 flex items-center justify-center shrink-0 border border-zinc-300 dark:border-white/10 text-zinc-900 dark:text-zinc-50 font-medium text-sm">01</div>
              <div>
                <h3 className="text-xl font-medium tracking-tight text-zinc-900 dark:text-zinc-50 mb-3">Smart Capture</h3>
                <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
            ...
            <div className="p-8 md:p-10 rounded-3xl border border-zinc-200 dark:border-white/5 bg-zinc-100/50 dark:bg-zinc-900/10 flex flex-col md:flex-row gap-8 items-start">
              <div className="w-12 h-12 rounded-full bg-zinc-200 dark:bg-zinc-900 flex items-center justify-center shrink-0 border border-zinc-300 dark:border-white/10 text-zinc-900 dark:text-zinc-50 font-medium text-sm">02</div>
              <div>
                <h3 className="text-xl font-medium tracking-tight text-zinc-900 dark:text-zinc-50 mb-3">Instant Preview</h3>
                <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
            ...
            <div className="p-8 md:p-10 rounded-3xl border border-sky-200/50 dark:border-sky-900/20 bg-sky-50 dark:bg-sky-900/5 flex flex-col md:flex-row gap-8 items-start">
              <div className="w-12 h-12 rounded-full bg-sky-500/10 flex items-center justify-center shrink-0 border border-sky-500/20 text-sky-600 dark:text-sky-400 font-medium text-sm">03</div>
              <div>
                <h3 className="text-xl font-medium tracking-tight text-zinc-900 dark:text-zinc-50 mb-3">Universal Compatibility</h3>
                <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
      ...
      {/* Final CTA */}
      <section className="py-24 px-6 border-t border-zinc-200 dark:border-white/5">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-sky-500/5 dark:to-sky-900/10 -z-10"></div>
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-medium tracking-tighter text-zinc-900 dark:text-zinc-50 mb-6">Boost your productivity today.</h2>
          <p className="text-base text-zinc-600 dark:text-zinc-400 mb-10">Download iMemo Smart Clipboard and transform how you work with data.</p>
          
          <div className="flex justify-center">
            <Link 
              href="/download" 
              className="inline-flex items-center gap-2 text-sm font-medium text-zinc-50 dark:text-zinc-950 bg-zinc-900 dark:bg-zinc-50 hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-all px-10 py-4 rounded-full text-center"
            >
              <Download size={18} />
              Download for Free
            </Link>

    ...
    <div className="flex flex-col p-4 animate-in fade-in duration-500">
      <div className="relative mb-6">
        ...
        <input 
          ...
          className="w-full rounded-xl border border-white/10 bg-zinc-900/50 py-3 pl-10 pr-4 text-sm text-zinc-100 placeholder:text-zinc-600 focus:border-blue-500/50 focus:outline-none focus:ring-1 focus:ring-blue-500/50"
        />
      </div>
